...
export default function SearchWorkbench() {
  ...
  const activeSearchText = searchMode === 'freeform' ? freeformQuery : `${insuredName} ${vehicleNo} ${location} ${incidentKeywords}`;
  const targetCas = extractTargetCasualties(activeSearchText);
